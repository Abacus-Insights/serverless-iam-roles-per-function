    ...
    describe('defaultInherit not set', () => {
        ...
        describe('#createRolesPerFunction', () => {
            it('should create role per function', () => {
                ...
                chai_1.assert.equal(helloEmptyIamStatementsRole.Properties.ManagedPolicyArns[0], 'arn:aws:iam::aws:policy/service-role/AWSLambdaVPCAccessExecutionRole');
            ...
            it('should throw when external role is defined', () => {
                lodash_1.default.set(serverless.service, "functions.hello.role", "arn:aws:iam::0123456789:role/Test");
                chai_1.assert.throws(() => {
                    plugin.createRolesPerFunction();
                });
            });
